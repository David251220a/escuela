        ...
        <div class="caja-1">
            ...
            <div class="content-1">
                ...
                <table>
                    ...
                    <tbody>
                        <tr style="">
                            <td style="border-bottom: 1px dotted black">{{ number_format($matricula->alumnos->cedula, 0, ".", ".") }} - </td>
                            <td style="width:180px; border-bottom: 1px dotted black">
                                {{$matricula->alumnos->nombre}} {{$matricula->alumnos->apellido}}
                            </td>
                            <td style=""></td>
                        </tr>
                        <tr style="">
                ...
                <table>
                    ...
                    <tbody>
                        <tr style="">
                            <td colspan="2" style="border-bottom: 1px dotted black">COBRO DE MATRICULA</td>
                        </tr>
                        <tr style="">
