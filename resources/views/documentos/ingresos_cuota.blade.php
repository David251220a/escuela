                ...
                @foreach ($cobros as $item)
                    <tr>
                        <td style="text-align: left">
                            {{number_format($item->matricula_cuota->matricula->alumnos->cedula, 0, ".", ".")}} - {{ $item->matricula_cuota->matricula->alumnos->apellido }}, {{ $item->matricula_cuota->matricula->alumnos->nombre }}
                        </td>
                        <td style="text-align: center">{{ date('d/m/Y', strtotime($item->cobros->fecha_cobro)) }}</td>
                        <td style="text-align: right">{{ $item->matricula_cuota->cuota }}</td>
