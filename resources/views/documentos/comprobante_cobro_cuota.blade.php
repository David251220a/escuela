...
<html lang="en">
    ...
    <body>
        ...
        @if ($cobro->monto_cobrado_cuota > 0)
        ...
        @if ($cobro->monto_multa_a_cobrado)
            ...
            <div class="caja-1">
                ...
                <div class="content-1">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr style="">
                                <td colspan="2" style="border-bottom: 1px dotted black">COBRO MULTA CUOTA</td>
                            </tr>
                            <tr style="">
                                <td style="">Concepto</td>
                                <td></td>
                            ...
                            <tr style="">
                                ...
                                <td rowspan="2" style="padding: 0; width:50px; border-style: solid">
                                    <p style="line-height: 15px; width: 70px; padding: 0; font-weight: bold">
                                        {{ number_format($cobro->monto_multa_a_cobrado, 0, ".", ".") }}
                                    </p>
                                    <p style="width: 70px; padding: 0; font-size: 12px;">
                                        Total a Cobrar
                                    </p>
                            ...
                            <tr style="">
                                <td colspan="3" style="border-bottom: 1px dotted black">
                                    @php
                                        if($cobro->monto_multa_a_cobrado > 999999){
                                            $letra = 'DE GUARANIES';
                                        }else{
                                            $letra = ' GUARANIES';
                                        }
                                    @endphp
                                    {{$formatter->toMoney($cobro->monto_multa_a_cobrado, 0, $letra , '');}}
                                </td>
                            </tr>
                            <tr style="">
                                <td colspan="2" style="">Total Cobrado (en letras)</td>
