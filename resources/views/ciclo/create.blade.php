<x-app-layout>
    ...
    <h2 class="text-xl text-gray-500 font-semibold mb-2">Nuevo Ciclo</h2>
        ...
        <div class="mb-4 border-b border-gray-200">
            ...
            <div class="md:grid grid-cols-4 gap-4 px-4 py-6">
                ...
                <div class="mb-4">
                    ...
                    value="{{old('anio')}}" onkeyup="punto_decimal(this)" onchange="punto_decimal(this)" required>
                </div>

                <div class="mb-4">
                    <label for="">Fecha Inicio</label>
                    <input type="date" name="fecha_inicio" id="fecha_inicio" class="w-full rounded border-gray-400 enviar text-right" value="{{old('fecha_inicio')}}" required>
                </div>

                <div class="mb-4">
                    <label for="">Fecha Fin</label>
                    <input type="date" name="fecha_fin" id="fecha_fin" class="w-full rounded border-gray-400 enviar text-right" value="{{old('fecha_fin')}}" required>
                </div>
