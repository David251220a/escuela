                ...
                <div class="bg-white rounded overflow-hidden shadow mb-4">
                    ...
                    <div class="md:grid grid-cols-4 gap-4 px-4 py-6">
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="id_madre" id="id_madre" class="w-full rounded border-gray-400 enviar" value="0">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="id_padre" id="id_padre" class="w-full rounded border-gray-400 enviar" value="0">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="id_encargado" id="id_encargado" class="w-full rounded border-gray-400 enviar" value="0">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="id_encargado1" id="id_encargado1" class="w-full rounded border-gray-400 enviar" value="0">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="id_encargado2" id="id_encargado2" class="w-full rounded border-gray-400 enviar" value="0">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="id_encargado3" id="id_encargado3" class="w-full rounded border-gray-400 enviar" value="0">
                        </div>
        ...
        document.addEventListener('keydown', (event) => {
            ...
            if (event.keyCode == 13) {
                ...
                if(event.target.id == 'cedula_madre'){
                    ...
                    if(cedula == 0){
                        document.getElementById('id_madre').value = 0;
                ...
                if(event.target.id == 'cedula_padre'){
                    ...
                    if(cedula == 0){
                        document.getElementById('id_padre').value = 0;
                ...
                if(event.target.id == 'cedula_encargado'){
                    ...
                    if(cedula == 0){
                        document.getElementById('id_encargado').value = 0;
                ...
                if(event.target.id == 'cedula_encargado1'){
                    ...
                    if(cedula == 0){
                        document.getElementById('id_encargado1').value = 0;
                ...
                if(event.target.id == 'cedula_encargado2'){
                    ...
                    if(cedula == 0){
                        document.getElementById('id_encargado2').value = 0;
                ...
                if(event.target.id == 'cedula_encargado3'){
                    ...
                    if(cedula == 0){
                        document.getElementById('id_encargado3').value = 0;
