                        ...
                        <table class="min-w-full divide-y divide-gray-200 rounded overflow-hidden shadow">
                            ...
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider text-center">Grado - Turno</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                @foreach ($cobros as $item)
                                    <tr>
                                        ...
                                        <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-500 text-left">
                                            {{ $item->matricula_cuota->matricula->alumnos->grado->nombre }} - {{ $item->matricula_cuota->matricula->alumnos->turno->nombre }}
                                        </td>
                                        ...
                                        <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-500 text-center">
                                            {{ $item->matricula_cuota->cuota }} - {{ date('m-d', strtotime($item->matricula_cuota->fecha_vencimiento)) }}
                                        </td>
                                        <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-500 text-right">
                                            {{ $item->cantidad }}
                                        </td>
