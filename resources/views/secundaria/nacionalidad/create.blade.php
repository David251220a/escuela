<x-app-layout>
    ...
    {{-- TITULO DE CABECERA. --}}
<h2 class="text-gray-600 font-semibold text-xl mb-6" >Crear Nacionalidad</h2>

    {{-- todo lo que esta ak adentro va a el controlador update --}}
    <form action="{{route('nacionalidad.store')}}" method="POST"  onsubmit="return checkSubmit();">
       @csrf
     ...
     <div name="Datos_de_la_tabla_Nacionalidad">
       ...
       <a href="{{route('nacionalidad.index')}}"" class="px-4 py-3 bg-red-600 text-white font-bold rounded">Cancelar</a>
