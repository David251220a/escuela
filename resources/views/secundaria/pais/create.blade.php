<x-app-layout>
    ...
    {{-- TITULO DE CABECERA. --}}
<h2 class="text-gray-600 font-semibold text-xl mb-6" >Crear Pais</h2>

    {{-- todo lo que esta ak adentro va a el controlador update --}}
    <form action="{{route('pais.store')}}" method="POST"  onsubmit="return checkSubmit();">
       @csrf
     ...
     <div name="Datos_de_la_tabla_Pais">
       ...
       <a href="{{route('pais.index')}}"" class="px-4 py-3 bg-red-600 text-white font-bold rounded">Cancelar</a>
