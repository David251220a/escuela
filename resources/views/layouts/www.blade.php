...
<head>
    <meta charset="utf-8">
    <title>Escuela Huerto Getsemani</title>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="{{route('inicio')}}" class="nav-item nav-link">Quienes Somos</a>
                <a href="{{route('inicio')}}" class="nav-item nav-link">Grados</a>
                <a href="{{route('inicio')}}" class="nav-item nav-link">Noticias</a>
                <a href="{{route('inicio')}}" class="nav-item nav-link">Contactanos</a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="">Grados</a>
                    <a class="btn btn-link" href="">Contactanos</a>
                </div>
                <div class="col-lg-4 col-md-6">
                    <h4 class="text-white mb-3">Contacto</h4>
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Via Ferrea</p>
                    <p class="mb-2"><a href="https://api.whatsapp.com/send?phone=595983602155">
                        <i class="fa fa-phone-alt me-3"></i>+595 981 977 139</a></p>
                    <p class="mb-2" st><i class="fa fa-envelope me-3"></i>*********</p>
                    <div class="d-flex pt-2">
                        <a class="btn btn-outline-light btn-social" target="__blank" href="#"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-outline-light btn-social" target="__blank" href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </div>
